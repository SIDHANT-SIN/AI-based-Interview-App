...
const styles: Record<string, React.CSSProperties> = {
  ...
  /* all real content sits above the decorative layers */
  content: {
    position: "relative",
    zIndex: 1,
    display: "flex",
  ...
  /*
   * We let Clerk render its own card.
   * This wrapper just ensures it's centered and never overflows on mobile.
   */
  clerkWrapper: {
    width: "100%",
    display: "flex",
