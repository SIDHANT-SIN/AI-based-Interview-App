...
export const setupHrRoom = async (file, token) => {
...
export const setupCodingRoom = async (token) => {
  try {
...
export const fetchSummary = async (roomName, token) => {
...
export const fetchCodingProblem = async (roomName, token) => {
